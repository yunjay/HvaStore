...
function blackBoxTest(name) {
    return __awaiter(this, void 0, void 0, function () {
        var modelPath, sqlDumpPath, model, sqlDump, parser, refModel, dbClient, wrappedClient, connector, introspectionResult, unnormalized, normalizedWithoutReference, normalizedWithReference, renderer, renderedWithReference;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    parser = new prisma_datamodel_1.RelationalParser();
                ...
                case 6:
                    ...
                    renderer = new prisma_datamodel_1.RelationalRenderer();

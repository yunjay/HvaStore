...
var Parser = /** @class */ (function () {
     ...
     * @param name
     */
    Parser.prototype.getDirectivesByName = function (fieldOrType, name) {
     ...
     * @param field
     */
    Parser.prototype.getDatabaseFieldName = function (field) {
     ...
     * @param field
     */
    Parser.prototype.getDatabaseTypeName = function (type) {
        return this.getDatabaseName(type);
    };
    /**
     * Returns the value of a directive argument.
     */
    Parser.prototype.getDirectiveArgument = function (directive, name) {
     ...
     */
    Parser.prototype.getObjectFieldValue = function (obj, name) {
        if (obj && obj.fields) {
     ...
     */
    Parser.prototype.parseIndex = function (indexObject, fields) {
     ...
     */
    Parser.prototype.parseIndices = function (type, fields) {
        var _this = this;
